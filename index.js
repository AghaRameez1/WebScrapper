...
async function run() {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            await page.goto('https://www.tripadvisor.com/Restaurants-g188057-Geneva.html', { waitUntil: 'networkidle0' });
            ...
            try {
                for (var i = 0; i < resLinks.length; i++) {
                    ...
                    await page1.close();
                        ...
                        data = data + resData[0].name + '\t' + resData[0].address + '\t' + resData[0].website + '\t' + resData[0].email + '\t' + resData[0].phoneNumber + '\n';
                }
